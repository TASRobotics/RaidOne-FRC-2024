...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    private final JoystickButton armMotionProfile = new JoystickButton(driver, XboxController.Button.kY.value);
    private final JoystickButton armhome = new JoystickButton(driver, XboxController.Button.kX.value);
    private final JoystickButton bothMotionMagic = new JoystickButton(driver, XboxController.Button.kRightBumper.value);
    ...
    private void configureButtonBindings() {
       ...
       // zeroPose.onTrue(new InstantCommand(() -> swerve.setPose(new Pose2d(new Translation2d(0,0), new Rotation2d(0)))));
        ...
        wristgo.onTrue(sequences.intakePos());
